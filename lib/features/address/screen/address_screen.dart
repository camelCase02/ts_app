      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Subtotal : ₹ ${widget.sum.toString()}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
            CustomTextfield(controller: addressController, hintText: 'Address'),
            const SizedBox(height: 10,),
            Center(child: Text("OR", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),)),
            const SizedBox(height: 10,),
            CustomTextfield(controller: addressController, hintText: 'Address Line 1'),
            const SizedBox(height: 10,),
            CustomTextfield(controller: addressController, hintText: 'City'),
            const SizedBox(height: 10,),
            CustomTextfield(controller: addressController, hintText: 'State'),
            const SizedBox(height: 10,),
            CustomTextfield(controller: addressController, hintText: 'Pincode'),  
            const SizedBox(height: 10,),
            CustomButton(
              onTap: () {
                showDialog(
